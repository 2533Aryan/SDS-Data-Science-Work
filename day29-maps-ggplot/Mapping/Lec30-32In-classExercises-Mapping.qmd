...
notable_city<- tibble(
  address=c("Boston",  "Northampton, MA", "Easthampton, MA", "Amherst, MA")) |>
  geocode(address, method = "osm") |>
  mutate(
    name = c("Boston", "Northampton", "Easthampton", "Amherst")
)
...
wa_counties <- read_sf("WA_counties/") |>
  st_transform(crs = 4326)
